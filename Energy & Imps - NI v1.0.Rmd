...
year <- readline(prompt = "State YEAR of settlement week: ")
...
for (f in 1:7) {
  ...
  # ensure that filter out everything not in the reqd week
...
for (f in 1:7) {
  ...
  #ensure filter out dates not form required week
  unique_dates <- seq(from = as.Date(firstday2, format = "%Y-%m-%d"), by = 1, length.out = 7)
  unique_dates <- format(unique_dates, "%Y%m%d")
  unique_dates <- paste(unique_dates, collapse = "|")
  xmlfile <- xmlfile[grepl(x = xmlfile, pattern = unique_dates)]
...
# mywb <- loadWorkbook(outputfile)
# addWorksheet(mywb, sheetName = "Summary", tabColour = '#F4B084', visible = TRUE)
# 
# activesheet <- `activeSheet<-`(mywb, 'Summary')$ActiveSheet
# dates <- seq(from = as.Date(firstday, format = "%Y%m%d"), by = "1 day", length.out = 7)
# charges <- c('CCA', 'CDIFFPDA', 'CDIFFPID', 'CDIFFPIMB', 'CIMB', 'CIMP', 'CREIMDIFFP', 'CREV', 'CSHORTDIFF')
# 
# # Create top table in summary sheet
# for (i in 1:7) {
#   writeData(wb = mywb, sheet = activesheet, x = dates[i], startCol = i+1)
# }
...
# 
# # Insert the formulae for the top table
...
# for (COLUMN in 2:8) {
#   for (ROW in 2:10) {
#     writeFormula(wb = mywb, sheet = activesheet, x = paste0("=SUMIFS(INDEX(DOCUMENT!$A:$BX,0,60),INDEX(DOCUMENT!$A:$BX,0,56),Summary!", number_to_letter(COLUMN), "$1,INDEX(DOCUMENT!$A:$BX,0,59),Summary!$A", ROW, ")"), xy = c(COLUMN, ROW))
#   }
# }
...
headings <- c("Date", "Month", "HH1","HH2","HH3","HH4","HH5","HH6","HH7","HH8","HH9","HH10","HH11","HH12","HH13","HH14","HH15","HH16","HH17","HH18","HH19","HH20","HH21","HH22","HH23","HH24","HH25","HH26","HH27","HH28","HH29","HH30","HH31","yHH32","HH33","HH34","HH35","HH36","HH37","HH38","HH39","HH40","HH41","HH42","HH43","HH44","HH45","HH46","HH47","HH48","HH49","HH50", "Sum")
...
unique_dates <- unique(MMfile$Date) #%>% format("%Y-%m-%d")
my598 <- data.frame(matrix(ncol = 53, nrow = 7))
colnames(my598) <- headings
days598 <- seq(from = as.Date(firstday2, format = "%Y-%m-%d"), by = 1, length.out = 7)
...
MMfile$Date <- as.POSIXct(MMfile$Date, format = "%d/%m/%Y")
MMfile$Month <- as.Date(MMfile$Date, format = "%d/%m/%Y")
MMfile$Month <- format(MMfile$Date, "%b-%y")
MMfile$Sum <- rowSums(MMfile[, c("HH1","HH2","HH3","HH4","HH5","HH6","HH7","HH8","HH9","HH10","HH11","HH12","HH13","HH14","HH15","HH16","HH17","HH18","HH19","HH20","HH21","HH22","HH23","HH24","HH25","HH26","HH27","HH28","HH29","HH30","HH31","HH32","HH33","HH34","HH35","HH36","HH37","HH38","HH39","HH40","HH41","HH42","HH43","HH44","HH45","HH46","HH47","HH48","HH49","HH50")], na.rm = TRUE)
...
outputfile <- paste0("X:\\GeneralAccounts\\Settlement\\", MMtype, " MM\\", settype2, " ", mm, " MM\\", MMtype2, " MASTER MM Messages ", settype, " - Updated.xlsx")
