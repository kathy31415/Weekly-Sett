...
requiredpackages <- c("berryFunctions", "dplyr", "lubridate", "pivottabler", "purrr", "readxl", "openxlsx", "shiny", "tidyr", "XML", "xml2")
...
settype <- readline(green(prompt = "State TYPE of settlement (D4 / M4 / M13 / AH): "))

if (toupper(settype) == "D4") {
  settype <- "D+4"
  ...
  stop("Settlement type not recognised. Stopping...")
}
...
year <- substr(as.numeric(firstday), 1, 4)
