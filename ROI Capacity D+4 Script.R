...
outputfile <- paste0(accdrive, ":/GeneralAccounts/Settlement/", PTunit, " SEMO Shadow Settlement/Capacity/D4/20", year, " ", month.as.number, ". ", PTunit, " SEMO ", month, " ", year, " ", settype, " CAPACITY Shadow Settlement - ", initials, ".xlsx")
...
temp <- c()
for (ROW in 2:1489) {
  temp <- c(temp, paste0("=('Consumption Checks'!O", ROW, "*SUMIFS('CRM REPORT'!$M:$M,'CRM REPORT'!$L:$L,'En & Imp Split'!$B", ROW+2, ",'CRM REPORT'!$J:$J,\"FQMCC\")*'SHADOW SETTLED'!$", LETTERS[which_column], "$2)"))
}
writeFormula(mywb, EIS, temp, startRow = 4, startCol = 5)

temp <- c()
for (ROW in 2:1489) {
  temp <- c(temp, paste0("=('Consumption Checks'!P", ROW, "*SUMIFS('CRM REPORT'!$M:$M,'CRM REPORT'!$L:$L,'En & Imp Split'!$B", ROW+2, ",'CRM REPORT'!$J:$J,\"FQMCC\")*'SHADOW SETTLED'!$", LETTERS[which_column], "$2)"))
}
writeFormula(mywb, EIS, temp, startRow = 4, startCol = 6)

temp <- c()
for (ROW in 2:1489) {
  temp <- c(temp, paste0("=('Consumption Checks'!Q", ROW, "*SUMIFS('CRM REPORT'!$M:$M,'CRM REPORT'!$L:$L,'En & Imp Split'!$B", ROW+2, ",'CRM REPORT'!$J:$J,\"FQMCC\")*'SHADOW SETTLED'!$", LETTERS[which_column], "$2)"))
}
...
temp <- c()
for (ROW in 2:1489) {
  temp <- c(temp, paste0("=E", ROW+2, "*'SHADOW SETTLED'!$", LETTERS[which_column], "$3"))
}
writeFormula(mywb, EIS, temp, startRow = 4, startCol = 13)

temp <- c()
for (ROW in 2:1489) {
  temp <- c(temp, paste0("=F", ROW+2, "*'SHADOW SETTLED'!$", LETTERS[which_column], "$3"))
}
writeFormula(mywb, EIS, temp, startRow = 4, startCol = 14)

temp <- c()
for (ROW in 2:1489) {
  temp <- c(temp, paste0("=G", ROW+2, "*'SHADOW SETTLED'!$", LETTERS[which_column], "$3"))
}
...
temp <- c()
for (ROW in 2:1489) {
  temp <- c(temp, paste0("='Consumption Checks'!O", index, "*'SHADOW SETTLED'!$", LETTERS[which_column], "$4*VLOOKUP($A", index+2, ",'MO Summary'!$P$8:$S$38,4,0)"))
}
writeFormula(mywb, EIS, temp, startRow = 4, startCol = 21)

temp <- c()
for (ROW in 2:1489) {
  temp <- c(temp, paste0("='Consumption Checks'!P", index, "*'SHADOW SETTLED'!$", LETTERS[which_column], "$4*VLOOKUP($A", index+2, ",'MO Summary'!$P$8:$S$38,4,0)"))
}
writeFormula(mywb, EIS, temp, startRow = 4, startCol = 22)

temp <- c()
for (ROW in 2:1489) {
  temp <- c(temp, paste0("='Consumption Checks'!Q", index, "*'SHADOW SETTLED'!$", LETTERS[which_column], "$4*VLOOKUP($A", index+2, ",'MO Summary'!$P$8:$S$38,4,0)"))
}
...
temp <- c()
for (ROW in 2:1393) {
  temp <- c(temp, paste0("=VLOOKUP(A", ROW, ",'", accdrive, ":/GeneralAccounts/Settlement/ESB MM/D+4 Initial 20 MM/[ESB MASTER MM Messages D+4.xlsx]MM596'!$A:$AY,D", ROW, ",0)"))
}
...
temp <- c()
for (ROW in 2:1393) {
  temp <- c(temp, paste0("=VLOOKUP($L", ROW, ",'", accdrive, ":/GeneralAccounts/Settlement/ESB MM/D+4 Initial 20 MM/[ESB MASTER MM Messages D+4.xlsx]MM595 LA'!$A:$AZ,$M", ROW, ",0)/1000"))
}
writeFormula(mywb, CC, temp, startRow = 2, startCol = 15)

temp <- c()
for (ROW in 2:1393) {
  temp <- c(temp, paste0("=VLOOKUP($L", ROW, ",'", accdrive, ":/GeneralAccounts/Settlement/ESB MM/D+4 Initial 20 MM/[ESB MASTER MM Messages D+4.xlsx]MM591 LA'!$A:$AY,$M", ROW, ",0)/1000"))
}
writeFormula(mywb, CC, temp, startRow = 2, startCol = 16)

temp <- c()
for (ROW in 2:1393) {
  temp <- c(temp, paste0("=VLOOKUP($L", ROW, ",'", accdrive, ":/GeneralAccounts/Settlement/ESB MM/D+4 Initial 20 MM/[ESB MASTER MM Messages D+4.xlsx]MM598'!$A:$AZ,$M", ROW, ",0)/1000"))
}
