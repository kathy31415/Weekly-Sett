...
# }
documentdata <- read_excel(path = inputfiles)
...
if (as.Date(firstdayd4, format = "%Y%m%d") >= as.Date("20221001", format = "%Y%m%d") & as.Date(firstdayd4, format = "%Y%m%d") <= as.Date("20230930", format = "%Y%m%d")) {
  # purchases
  writeFormula(wb = mywb, sheet = "Summary", x = "=SUM('Consumption Checks'!CP3:CP338)+B39+B63+B75+B87", xy = c(12,18))
  writeFormula(wb = mywb, sheet = "Summary", x = "=SUM('Consumption Checks'!CQ3:CQ338)+C39+C63+C75+C87", xy = c(13,18))
  writeFormula(wb = mywb, sheet = "Summary", x = "=SUM('Consumption Checks'!CR3:CR338)+D39+D63+D75+D87", xy = c(14,18))


  # sales
  writeFormula(wb = mywb, sheet = "Summary", x = "=SUM('Consumption Checks'!CL3:CL338)+B51", xy = c(12,19))
  writeFormula(wb = mywb, sheet = "Summary", x = "=SUM('Consumption Checks'!CM3:CM338)+C51", xy = c(13,19))
  writeFormula(wb = mywb, sheet = "Summary", x = "=SUM('Consumption Checks'!CN3:CN338)+D51", xy = c(14,19))

} else {
  # purchases
  writeFormula(wb = mywb, sheet = "Summary", x = "=SUM('Consumption Checks'!CP3:CP338)+B39+B63+B75+B87+B51", xy = c(12,18))
...
for (row in c(2:5)) {
  addStyle(wb = mywb, sheet = SS, style = euro, rows = row, cols = 16:21)
}
...
writeFormula(mywb, CC, x = "=AL3", startRow = 3, startCol = 41)
...
writeFormula(mywb, CC, x = "=AO3+1", startRow = 48, startCol = 41)
...
temp <- c()
for (index in 3:338) {
  temp <- c(temp, paste0("=SUMIFS(REPORT!$S:$S,REPORT!$R:$R,'Consumption Checks'!$AK", index, ",REPORT!$P:$P,\"QEX\",REPORT!$O:$O, $BB$1)"))
}
...
temp <- c()
for (index in 3:338) {
  temp <- c(temp, paste0("=SUMIFS(F:F,C:C,BP", index, ")*'SHADOW SETTLED'!$", toupper(letters[which_column]), "$4*SUMIFS(REPORT!M:M,REPORT!N:N,'Consumption Checks'!BP", index, ",REPORT!J:J,\"FCCA\")"))
}
...
temp <- c()
for (index in 3:338) {
  temp <- c(temp, paste0("=SUMIFS('EX-Ante Report'!$T:$T,'EX-Ante Report'!$S:$S,'Ex-ante Consumption'!C", index, ",'EX-Ante Report'!$K:$K,\"EGRD\",'EX-Ante Report'!$I:$I,\"IT2\",'EX-Ante Report'!$AK:$AK,IF(O", index, "=0,\"AU_400131_&_AU_400131\",\"SU_400173_&_SU_400173\"))"))
}
writeFormula(wb = mywb, sheet = EAC, x = temp, startRow = 3, startCol = 28)

temp <- c()
for (index in 3:338) {
  temp <- c(temp, paste0("=SUMIFS('EX-Ante Report'!$T:$T,'EX-Ante Report'!$S:$S,'Ex-ante Consumption'!C", index, ",'EX-Ante Report'!$K:$K,\"EGRD\",'EX-Ante Report'!$I:$I,\"IT3\",'EX-Ante Report'!$AK:$AK,'Consumption Checks'!$BC$1)"))
}
...
temp <- c()
for (index in 3:9) {
  temp <- c(temp, paste0("=SUMIF($D:$D,$AY", index, ",AU:AU)"))
}
...
weekno <- as.numeric(format(as.Date(firstday2), "%U")) # %U so weeks start on Sunday
weekno <- as.character(weekno)
if (nchar(weekno) == 1) {
  weekno <- paste0("0", weekno)
}
...
prevfile <- prevfile[grepl(x = prevfile, pattern = PTunit)]
...
if (as.Date(firstdaym4, format = "%Y%m%d") >= as.Date("20221001", format = "%Y%m%d") & as.Date(firstdaym4, format = "%Y%m%d") <= as.Date("20230930", format = "%Y%m%d")) {
  # purchases
  writeFormula(wb = mywb, sheet = "Summary", x = "=SUM('Consumption Checks'!CP3:CP338)+B39+B63+B75+B87", xy = c(12,19))
  ...
  # purchases
  writeFormula(wb = mywb, sheet = "Summary", x = "=SUM('Consumption Checks'!CP3:CP338)+B39+B63+B75+B87+B51", xy = c(12,19))
...
# refer to D+4 for datetime formulas
prevtypefile <- list.files(path = paste0(accdrive, ":/GeneralAccounts/Settlement/", PTunit, " SEMO Shadow Settlement/Energy + Imp/D+4 INITIAL/"), full.names = FALSE)
prevtypefile <- prevtypefile[grepl(x = prevtypefile, pattern = as.character(weekno))]
prevtypefile <- prevtypefile[grepl(x = prevtypefile, pattern = as.character(year))]
if (length(prevtypefile) > 1) {
  prevtypefile <- prevtypefile[-grepl(x = prevtypefile, pattern = "~\\$")]
} else if (length(prevtypefile) < 1) {
  stop("Could not find D+4 file for this week. Stopping...")
}
prevtypefile2 <- paste0("'", accdrive, ":/GeneralAccounts/Settlement/", PTunit, " SEMO Shadow Settlement/Energy + Imp/D+4 Initial/[", prevtypefile, "]")


temp <- c()
for (index in 3:338) {
  temp <- c(temp, paste0(prevtypefile2, CC, "'!AI", index))
};
writeFormula(wb = mywb, sheet = CC, x = temp, startRow = 3, startCol = 35)

temp <- c()
for (index in 3:338) {
  temp <- c(temp, paste0(prevtypefile2, CC, "'!AJ", index))
}; writeFormula(wb = mywb, sheet = CC, x = temp, startRow = 3, startCol = 36)

temp <- c()
for (index in 3:338) {
  temp <- c(temp, paste0(prevtypefile2, CC, "'!AK", index))
}
writeFormula(wb = mywb, sheet = CC, x = temp, startRow = 3, startCol = 37)

temp <- c()
for (index in 3:338) {
  temp <- c(temp, paste0(prevtypefile2, CC, "'!AL", index))
}
writeFormula(wb = mywb, sheet = CC, x = temp, startRow = 3, startCol = 38)
...
temp <- c()
for (index in 3:338) {
  temp <- c(temp, paste0(prevtypefile2, CC, "'!AM", index))
}
writeFormula(wb = mywb, sheet = CC, x = temp, startRow = 3, startCol = 39)

temp <- c()
for (index in 3:338) {
  temp <- c(temp, paste0(prevtypefile2, CC, "'!AN", index))
}
writeFormula(mywb, CC, x = temp, startRow = 3, startCol = 40)

temp <- c()
for (index in 3:338) {
  temp <- c(temp, paste0(prevtypefile2, CC, "'!AO", index))
}
writeFormula(mywb, CC, x = temp, startRow = 3, startCol = 41)

temp <- c()
for (index in 3:338) {
  temp <- c(temp, paste0(prevtypefile2, CC, "'!AP", index))
}
writeFormula(mywb, CC, x = temp, startRow = 3, startCol = 42)

temp <- c()
for (index in 3:338) {
  temp <- c(temp, paste0(prevtypefile2, CC, "'!AQ", index))
}
writeFormula(mywb, CC, x = temp, startRow = 3, startCol = 43)
...
temp <- c()
for (index in 3:338) {
  temp <- c(temp, paste0("=SUMIFS(F:F,C:C,BP", index, ")*'SHADOW SETTLED'!$", LETTERS[which_column], "$4*SUMIFS(REPORT!M:M,REPORT!N:N,'Consumption Checks'!BP", index, ",REPORT!J:J,\"FCCA\")"))
}
writeFormula(wb = mywb, sheet = CC, x = temp, startRow = 3, startCol = 88)
...
temp <- c()
for (index in 4:339) {
  temp <- c(temp, paste0("=IFERROR(((MIN(SUMIFS('Consumption Checks'!$AD:$AD,'Consumption Checks'!$X:$X,'En & Imp Split'!$AA", index, ",'Consumption Checks'!$Y:$Y,'En & Imp Split'!$AB", index, "),0)*MIN(0,('SHADOW SETTLED'!$", LETTERS[which_column], "$5-SUMIFS(REPORT!$M:$M,REPORT!$N:$N,'En & Imp Split'!$C", index, ",REPORT!$J:$J,\"PIMB\"))))*('Consumption Checks'!O", index-1, "/'Consumption Checks'!$R", index-1, ")),0)"))
}; writeFormula(wb = mywb, sheet = EIS, x = temp, startRow = 4, startCol = 30)

temp <- c()
for (index in 4:339) {
  temp <- c(temp, paste0("=IFERROR(((MIN(SUMIFS('Consumption Checks'!$AD:$AD,'Consumption Checks'!$X:$X,'En & Imp Split'!$AA", index, ",'Consumption Checks'!$Y:$Y,'En & Imp Split'!$AB", index, "),0)*MIN(0,('SHADOW SETTLED'!$", LETTERS[which_column], "$5-SUMIFS(REPORT!$M:$M,REPORT!$N:$N,'En & Imp Split'!$C", index, ",REPORT!$J:$J,\"PIMB\"))))*('Consumption Checks'!P", index-1, "/'Consumption Checks'!$R", index-1, ")),0)"))
}; writeFormula(wb = mywb, sheet = EIS, x = temp, startRow = 4, startCol = 31)

temp <- c()
for (index in 4:339) {
  temp <- c(temp, paste0("=IFERROR(((MIN(SUMIFS('Consumption Checks'!$AD:$AD,'Consumption Checks'!$X:$X,'En & Imp Split'!$AA", index, ",'Consumption Checks'!$Y:$Y,'En & Imp Split'!$AB", index, "),0)*MIN(0,('SHADOW SETTLED'!$", LETTERS[which_column], "$5-SUMIFS(REPORT!$M:$M,REPORT!$N:$N,'En & Imp Split'!$C", index, ",REPORT!$J:$J,\"PIMB\"))))*('Consumption Checks'!Q", index-1, "/'Consumption Checks'!$R", index-1, ")),0)"))
}; writeFormula(wb = mywb, sheet = EIS, x = temp, startRow = 4, startCol = 32)
...
inputfiles <- inputfiles[grepl(pattern = "\\.xlsx$", x = inputfiles)]
inputfiles <- inputfiles[grepl(x = inputfiles, pattern = PTunit)]
inputfiles <- inputfiles[grepl(x = inputfiles, pattern = "Document|W")]
if (length(inputfiles) != 3) {
  stop("Ensure previous settlement files have been deleted from your Downloads folder before running. Stopping...")
}
...
# refer to M4 for datetime formulas
prevtypefile <- list.files(path = paste0(accdrive, ":/GeneralAccounts/Settlement/", PTunit, " SEMO Shadow Settlement/Energy + Imp/M+4 Resettlement/"), full.names = FALSE)
prevtypefile <- prevtypefile[grepl(x = prevtypefile, pattern = as.character(weekno))]
prevtypefile <- prevtypefile[grepl(x = prevtypefile, pattern = as.character(year))]
if (length(prevtypefile) > 1) {
  prevtypefile <- prevtypefile[-grepl(x = prevtypefile, pattern = "~\\$")]
...
prevtypefile2 <- paste0("'", accdrive, ":/GeneralAccounts/Settlement/", PTunit, " SEMO Shadow Settlement/Energy + Imp/M+4 Resettlement/[", prevtypefile, "]")
...
temp <- c()
for (index in 4:339) {
  temp <- c(temp, paste0("=IFERROR(SUMIF('Consumption Checks'!$C:$C,'En & Imp Split'!$C", index, ",'Consumption Checks'!BT:BT)*MIN(0,('SHADOW SETTLED'!$", LETTERS[which_column], "$5-SUMIFS(REPORT!$M:$M,REPORT!$N:$N,'En & Imp Split'!$C", index, ",REPORT!$J:$J,\"PIMB\"))),0)"))
}
writeFormula(wb = mywb, sheet = EIS, x = temp, startRow = 4, startCol = 30)

temp <- c()
for (index in 4:339) {
  temp <- c(temp, paste0("=IFERROR(SUMIF('Consumption Checks'!$C:$C,'En & Imp Split'!$C", index, ",'Consumption Checks'!BU:BU)*MIN(0,('SHADOW SETTLED'!$", LETTERS[which_column], "$5-SUMIFS(REPORT!$M:$M,REPORT!$N:$N,'En & Imp Split'!$C", index, ",REPORT!$J:$J,\"PIMB\"))),0)"))
}
writeFormula(wb = mywb, sheet = EIS, x = temp, startRow = 4, startCol = 31)

temp <- c()
for (index in 4:339) {
  temp <- c(temp, paste0("=IFERROR(SUMIF('Consumption Checks'!$C:$C,'En & Imp Split'!$C", index, ",'Consumption Checks'!BV:BV)*MIN(0,('SHADOW SETTLED'!$", LETTERS[which_column], "$5-SUMIFS(REPORT!$M:$M,REPORT!$N:$N,'En & Imp Split'!$C", index, ",REPORT!$J:$J,\"PIMB\"))),0)"))
}
writeFormula(wb = mywb, sheet = EIS, x = temp, startRow = 4, startCol = 32)
...
if (InitCaps == TRUE) {
  ...
  source("ROI Capacity D+4 Script.R")
  print_colour("\nD+4 Capacity file created.", colour = "green")
} else {
  print_colour("\nNo D+4 Capacity settlement required.", colour = "blue")
}
...
if (M4Caps == TRUE) {
  ...
  source("ROI Capacity M+4 Script.R")
  print_colour("\nM+4 Capacity file created.", colour = "green")
} else {
  print_colour("\nNo M+4 Capacity settlement required.", colour = "blue")
}
...
if (M13Caps == TRUE) {
  ...
  source("ROI Capacity M+13 Script.R")
  print_colour("\nM+13 Capacity file created.", colour = "green")
} else {
  print_colour("\nNo M+13 Capacity settlement required.", colour = "blue")
}
...
print_colour("Script has finished executing.\n", colour = "green")
