...
writeFormula(wb = mywb, sheet = "Summary", x = temp, startRow = 92, startCol = 2)

temp <- c()
for (index in c(startingrow:startingrow+6)) {
  temp <- c(temp, paste0("=SUMIFS(STATEMENT!P:P,STATEMENT!D:D,Summary!A", index, ",STATEMENT!N:N,\"CCA\")"))
}
writeFormula(wb = mywb, sheet = "Summary", x = temp, startRow = 92, startCol = 3)

temp <- c()
for (index in c(startingrow:startingrow+6)) {
  temp <- c(temp, paste0("=B", index, "-C", index))
}
writeFormula(wb = mywb, sheet = "Summary", x = temp, xy = c(4,92))
...
for (index in 3:48) {
  writeFormula(wb = mywb, sheet = CC, x = paste0("=AL", index), startRow = 3, startCol = 41)
}
writeFormula(mywb, CC, x = "=AO47", startRow = 49, startCol = 41)
writeFormula(mywb, CC, x = "=AO47", startRow = 50, startCol = 41)
for (index in 3:288) {
  writeFormula(wb = mywb, sheet = CC, x = paste0("=AO", index), startRow = 51, startCol = 41)
}
...
temp <- c()
for (index in 101:142) {
  temp <- c(temp, paste0("=AI", index))
}
writeFormula(wb = mywb, sheet = CC, x = temp, startRow = 101, startCol = 38)
temp <- c()
for (index in 143:148) {
  temp <- c(temp, paste0("=AI", index, "+1"))
}
writeFormula(wb = mywb, sheet = CC, x = temp, startRow = 143, startCol = 38)
temp <- c()
for (index in 149:190) {
  temp <- c(temp, paste0("=AI", index))
}
writeFormula(wb = mywb, sheet = CC, x = temp, startRow = 149, startCol = 38)
temp <- c()
for (index in 191:196) {
  temp <- c(temp, paste0("=AI", index, "+1"))
}
writeFormula(wb = mywb, sheet = CC, x = temp, startRow = 191, startCol = 38)
temp <- c()
for (index in 197:238) {
  temp <- c(temp, paste0("=AI", index))
}
writeFormula(wb = mywb, sheet = CC, x = temp, startRow = 197, startCol = 38)
temp <- c()
for (index in 239:244) {
  temp <- c(temp, paste0("=AI", index, "+1"))
}
writeFormula(wb = mywb, sheet = CC, x = temp, startRow = 239, startCol = 38)
temp <- c()
for (index in 245:286) {
  temp <- c(temp, paste0("=AI", index))
}
writeFormula(wb = mywb, sheet = CC, x = temp, startRow = 245, startCol = 38)
temp <- c()
for (index in 287:292) {
  temp <- c(temp, paste0("=AI", index, "+1"))
}
writeFormula(wb = mywb, sheet = CC, x = temp, startRow = 287, startCol = 38)
for (index in 293:334) {
  temp <- c(temp, paste0("=AI", index))
}
writeFormula(wb = mywb, sheet = CC, x = temp, startRow = 293, startCol = 38)
temp <- c()
for (index in 335:338) {
  temp <- c(temp, paste0("=AI", index, "+1"))
}
writeFormula(wb = mywb, sheet = CC, x = temp, startRow = 335, startCol = 38)
...
writeFormula(wb = mywb, sheet = CC, x = temp, startRow = 7, startCol = 35)
...
if ((firstday2 > as.Date(paste0(year,"-10-01"), format = "%Y-%m-%d") & firstday2 < as.Date(paste0(as.numeric(year)-1,"-4-01"), format = "%Y-%m-%d")) == FALSE) {
  temp <- winter
  season <- "winter"
} else {
  temp <- summer
...
writeData(wb = mywb, sheet = EIS, x = "CSHORTSDIFFP", startRow = 1, startCol = 34)
...
writeData(mywb, EMS, x = c("Sales at positive prices", rep.int("", times = 3),
                           "Purchases at negative prices", rep.int("", times = 3),
                           "Sales at negative Prices", rep.int("", times = 3),
                           "Purchases at positive prices"), startRow = 1, startCol = 2)

writeData(mywb, EMS, rep.int(c("Quantity", "", "Commodity", ""), times = 4), startRow = 2, startCol = 2)

writeData(mywb, EMS, rep.int(c("SU", "AU"), times = 8), startRow = 3, startCol = 2)
