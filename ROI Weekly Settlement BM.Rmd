...
# add sheets
addWorksheet(wb = mywb, sheetName = "Resettlement Summary")
...
# TOTALS
writeFormula(wb = mywb, sheet = "Summary", x = "=SUM(L18:L20)", xy = c(12,23))
writeFormula(wb = mywb, sheet = "Summary", x = "=SUM(M18:M20)", xy = c(13,23))
writeFormula(wb = mywb, sheet = "Summary", x = "=SUM(N18:N20)", xy = c(14,23))
writeFormula(wb = mywb, sheet = "Summary", x = "=SUM(O18:O20)", xy = c(15,23))
writeFormula(wb = mywb, sheet = "Summary", x = "=SUM(P18:P20)", xy = c(16,23))
writeFormula(wb = mywb, sheet = "Summary", x = "=SUM(L22:P22)", xy = c(17,23))
...
writeFormula(wb = mywb, sheet = EAC, x = paste0("=SUM(AZ3:AZ9)"), startRow = 11, startCol = 53)
writeFormula(wb = mywb, sheet = EAC, x = paste0("=SUM(BA3:BA9)"), startRow = 11, startCol = 54)
writeFormula(wb = mywb, sheet = EAC, x = paste0("=SUM(BB3:BB9)"), startRow = 11, startCol = 55)
writeFormula(wb = mywb, sheet = EAC, x = paste0("=SUM(BC3:BC9)"), startRow = 11, startCol = 56)
...
for (ROW in 3:11) {
  for (col in 52:56) {
    addStyle(mywb, EAC, euro, startRow = ROW, startCol = COL)
  }
}

temp <- c()
for (index in 3:338) {
  writeFormula(mywb, EAC, x = paste0("=0*(T", index, "*Z", index, ")+(U", index, "*AA", index, ")+(V", index, "*AB", index, ")+(W", index, "*A", index, ")"), startRow = 3, startCol = 49)
}
...
writeData(wb = mywb, sheet = EIS, x = "CSHORTSDIFFP", startRow = 1, startCol = 35)
