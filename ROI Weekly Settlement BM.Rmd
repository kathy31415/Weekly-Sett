...
writeFormula(wb = mywb, sheet = EAC, x = paste0("=SUM(BE3:BE9)"), startRow = 11, startCol = 52)
writeFormula(wb = mywb, sheet = EAC, x = paste0("=SUM(BF3:BF9)"), startRow = 11, startCol = 53)
writeFormula(wb = mywb, sheet = EAC, x = paste0("=SUM(BG3:BG9)"), startRow = 11, startCol = 54)
writeFormula(wb = mywb, sheet = EAC, x = paste0("=SUM(BH3:BH9)"), startRow = 11, startCol = 55)
