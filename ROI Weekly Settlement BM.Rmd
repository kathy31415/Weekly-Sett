...
addStyle(wb = mywb, sheet = CC, style = euro, rows = 1, cols = 75:97)
...
headings2 <- c("Settlement Date", "Trading Date",
               ...
               rep.int("", times = 4), "HH", "NHH", "PPA Gen", "Total",
               rep.int("", times = 4), "HH", "NHH", "PPA Gen", "Total",
               rep.int("", times = 6), "HH", "NHH", "PPA Gen", "Total",
...
writeData(wb = mywb, sheet = "Summary", startRow = 18, startCol = 15, x = "100006")
...
writeFormula(wb = mywb, sheet = "Summary", x = "=SUM(L18:P18)", xy = c(17,19))
...
writeFormula(wb = mywb, sheet = "Summary", x = "=SUM(L19:P19)", xy = c(17,20))

# ex ante
writeFormula(wb = mywb, sheet = "Summary", x = "='Ex-Ante Consumption'!AZ11", xy = c(12,21))
writeFormula(wb = mywb, sheet = "Summary", x = "='Ex-Ante Consumption'!BA11", xy = c(13,21))
writeFormula(wb = mywb, sheet = "Summary", x = "='Ex-Ante Consumption'!BB11", xy = c(14,21))
writeFormula(wb = mywb, sheet = "Summary", x = "='Ex-Ante Consumption'!BC11", xy = c(15,21))
writeFormula(wb = mywb, sheet = "Summary", x = "=SUM(L20:P20)", xy = c(17,21))

# TOTALS
writeFormula(wb = mywb, sheet = "Summary", x = "=SUM(L19:L21)", xy = c(12,23))
writeFormula(wb = mywb, sheet = "Summary", x = "=SUM(M19:M21)", xy = c(13,23))
writeFormula(wb = mywb, sheet = "Summary", x = "=SUM(N19:N21)", xy = c(14,23))
writeFormula(wb = mywb, sheet = "Summary", x = "=SUM(O19:O21)", xy = c(15,23))
writeFormula(wb = mywb, sheet = "Summary", x = "=SUM(P19:P21)", xy = c(16,23))
...
# CHECK
writeFormula(wb = mywb, sheet = "Summary", x = "=Q18+Q19+I13", xy = c(18,19))
writeFormula(wb = mywb, sheet = "Summary", x = paste0("=Q20-SUM('X:/Day Ahead/[ETS Results and Settlementv2.xlsx]Settlement Check'!$AF$1112:$AF$1118)"), xy = c(18,21))
