...
temp <- c()
for (index in 3:338) {
  temp <- c(temp, paste0("=SUMIFS('EX-Ante Report'!$T:$T,'EX-Ante Report'!$S:$S,'Ex-ante Consumption'!$C", index, ",'EX-Ante Report'!$K:$K,\"EGRD\",'EX-Ante Report'!$I:$I,\"IT2\",'EX-Ante Report'!$AK:$AK,IF(P", index, "=0,\"AU_400117_&_AU_400117\",\"SU_400173_&_SU_400173\"))"))
}
writeFormula(wb = mywb, sheet = EAC, x = temp, startRow = 3, startCol = 28)

temp <- c()
for (index in 3:338) {
  temp <- c(temp, paste0("=SUMIFS('EX-Ante Report'!$T:$T,'EX-Ante Report'!$S:$S,'Ex-ante Consumption'!$C", index, ",'EX-Ante Report'!$K:$K,\"EGRD\",'EX-Ante Report'!$I:$I,\"IT3\",'EX-Ante Report'!$AK:$AK,IF(Q", index, "=0,\"AU_400117_&_AU_400117\",\"SU_400173_&_SU_400173\"))"))
}
