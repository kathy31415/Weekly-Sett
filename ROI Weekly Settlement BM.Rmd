...
addStyle(wb = mywb, sheet = "Summary", style = thicktr, borderStyle= "thick"), rows = 14, cols = 20)
addStyle(wb = mywb, sheet = "Summary", style = thickbottoml, rows = 22, cols = 11)
addStyle(wb = mywb, sheet = "Summary", style = thickbottomr, rows = 22, cols = 20)
...
writeData(wb = mywb, sheet = "Summary", x = "Against Doc Total", startRow = 18, startCol = 18)
writeData(wb = mywb, sheet = "Summary", x = "Against AD Day Ahead Sheet", startRow = 20, startCol = 18)
